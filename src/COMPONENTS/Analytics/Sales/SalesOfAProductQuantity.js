...
class SalesOfAProductQuantity extends Component {
    ...
    draw(rows) {
        ...
        this.myChart = new Chart(ctx, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: i18next.t('sales-of-a-product-quantity'),
                    data: data,
                    fill: false,
    ...
    locateProducts() {
        ...
        ReactDOM.render(<LocateProduct
            ...
            onSelect={(product) => {
                ...
                this.salesOfAProductQuantity(this.currentSelectedProductId).then((data) => {
                    this.draw(data);
                });
            }}
    ...
    render() {
        return <div id="tabSalesOfAProductQuantity" className="formRowRoot">
            ...
            <h1>{i18next.t('sales-of-a-product-quantity')}</h1>
