...
import './../../../CSS/sales_delivery_note.css';
...
class SalesDeliveryNotes extends Component {
    ...
    render() {
        return <div id="tabSalesDeliveryNotes" className="formRowRoot">
            ...
            <div class="form-row">
                ...
                <div class="col">
                    ...
                    <div ref="advancedSearch" className="advancedSearch" id="salesDeliveryNoteAdvancedSearch"></div>
                </div>
            </div>
            <DataGrid
                ref="table"
