describe('Manual Purchase Invoice', () => {
    it('manual purchase invoice', () => {
        ...
        // write the supplier
        cy.get('#tabPurchaseInvoice > :nth-child(3) > :nth-child(2) > form > div > .form-control').click()
        cy.get('#tabPurchaseInvoice > :nth-child(3) > :nth-child(2) > form > div > .form-control').type('P')
        ...
        // detail 1
        cy.get('#purchaseInvoiceDetails > .btn').click()
        ...
        // detail 2
        cy.get('#purchaseInvoiceDetails > :nth-child(2)').click()
        cy.get('.modal-body > form > div > .form-control').click()
