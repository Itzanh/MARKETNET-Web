describe('Manual Sales Delivery Note', () => {
    it('manual sales delivery note', () => {
        ...
        // write the customer
        cy.get('#tabSaleDeliveryNote > :nth-child(3) > :nth-child(2) > form > div > .form-control').click()
        cy.get('#tabSaleDeliveryNote > :nth-child(3) > :nth-child(2) > form > div > .form-control').type('I')
        ...
        // detail 1
        cy.get('#salesDeliveryNoteDetails > .btn').click()
        ...
        // detail 2
        cy.get('#salesDeliveryNoteDetails > :nth-child(2)').click()
        cy.get('.modal-body > :nth-child(2) > div > .form-control').click()
